...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('finder', '0011_auto_20201016_0403'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='profile',
            name='gender',
            field=models.CharField(choices=[('', ''), ('Male', 'Male'), ('Female', 'Female'), ('Prefer Not to Answer', 'Prefer Not to Answer')], default='', max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='profile',
            name='graduation',
